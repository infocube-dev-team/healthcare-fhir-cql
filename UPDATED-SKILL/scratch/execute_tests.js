...
const testPatients = [
  { id: 'patient-eligible-nins', file: 'patient-eligible-nins.json' },
  { id: 'patient-eligible-bcs', file: 'patient-eligible-bcs.json' },
  { id: 'patient-eligible-baseline', file: 'patient-eligible-baseline.json' },
  { id: 'patient-baseline-fail', file: 'patient-baseline-fail.json' },
  { id: 'patient-ineligible', file: 'patient-ineligible.json' }
];
