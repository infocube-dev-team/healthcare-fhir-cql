...
const CQL_PATH = path.join(__dirname, '..', 'OsteoporosisScreeningStudy.cql');
const SANDBOX_URL = 'https://cloud.alphora.com/sandbox/r4/cds/fhir/$cql';

const testPatients = [
  { id: 'patient-osteo-ineligible-young', file: 'patient-osteo-ineligible-young.json' },
  { id: 'patient-osteo-ineligible-no-consent', file: 'patient-osteo-ineligible-no-consent.json' },
  { id: 'patient-osteo-moderate-risk', file: 'patient-osteo-moderate-risk.json' },
  { id: 'patient-osteo-high-risk-med', file: 'patient-osteo-high-risk-med.json' },
  { id: 'patient-osteo-high-risk-no-med', file: 'patient-osteo-high-risk-no-med.json' }
];
